...
<title>SAWARI SERIVICE - Responsive Car </title>
<!--Bootstrap -->
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input type="tel" name="contact no" class="form-control white_bg" id="phonenumber" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required>
            </div>
            <div class="form-group">

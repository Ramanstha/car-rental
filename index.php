      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>WELCOME TO SAWARI SERVICE.</h1>
            <p>When you need a car open the app and press a button. That's it.<br>
              Drivers in Sawari Service network are circling your neighborhood and by the magic of GPS the closest one is arriving at your door </p>
            <!--
            <a href="#" class="btn">Read More <span class="arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> -->
          </div>
        </div>
      </div>
    </div>

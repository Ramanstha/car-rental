...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,Phone,message,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:Phone,:message,:status)";
...
<title>SAWARI SERVICE | Vehicle Details</title>
<!--Bootstrap -->
